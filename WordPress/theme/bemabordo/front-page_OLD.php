...
<div id="home" class="container">
	...
	<div id="carousel">
		<div class="carouselImageContainer">
        	<img src="<?php echo get_bloginfo('template_directory'); ?>/image/carousel0.jpg" alt=""/>
		</div>
        <div class="carouselImageContainer"><img src="<?php echo get_bloginfo('template_directory'); ?>/image/carousel0.jpg" width="1067" height="600" alt=""/></div>
